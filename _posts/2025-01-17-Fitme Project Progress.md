...
# Fitme Currently
The Fitme Project progress currently is almost done,just needing a little bit of tweeking to the code and the design then its done. My team has added more details to the UI of the app,sound effects for the notification, and trying to combine the features of the app inside the code. [Click here to see the repository][https://github.com/Vqllerio/Project-ALP]
